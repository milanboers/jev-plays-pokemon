# Vendored from pokemon-agent (https://github.com/NousResearch/pokemon-agent), MIT License, Copyright (c) Nous Research.
...
class PyBoyEmulator(Emulator):
    ...
    Runs with a PyBoy window; ``window`` and ``scale`` are configurable.
    """

    def __init__(self, window: str = "null", scale: int = 3) -> None:
        super().__init__()
